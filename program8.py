...
save_to_csv("p8extracted-books.csv", ['SEM', 'SUB_CODE', "BOOK_ID", "GRADE_SCORED"], extracted_data)
...
save_to_csv("p8correlation-books.csv", ['SEM', 'SUB_CODE', "BOOK_ID", "GRADE_SCORED"], corr_ls)


corr_df = pd.read_csv("p8correlation-books.csv", index_col=0)
...
df = pd.read_csv("p8extracted-books.csv")
